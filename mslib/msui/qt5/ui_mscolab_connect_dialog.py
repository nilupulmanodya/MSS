...
class Ui_MSColabConnectDialog(object):
    def setupUi(self, MSColabConnectDialog):
        ...
        self.idpAuthPushButton = QtWidgets.QPushButton(self.layoutWidget)
        self.idpAuthPushButton.setObjectName("idpAuthPushButton")
        self.idpAuthGridLayout.addWidget(self.idpAuthPushButton, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MSColabConnectDialog):
        ...
        self.idpAuthPushButton.setText(_translate("MSColabConnectDialog", "Submit"))
